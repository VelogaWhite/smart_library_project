# Generated by Django 6.0.2 on 2026-02-22 12:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AuthorName', models.CharField(default='Unknown', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('FineAmount', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('Status', models.CharField(default='Unpaid', max_length=10)),
                ('BorrowID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='library_app.borrowingrecord')),
            ],
        ),
    ]
